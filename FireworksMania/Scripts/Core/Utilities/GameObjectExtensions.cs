...
{
    //Source https://github.com/adammyhre/Unity-Utils/blob/master/UnityUtils/Scripts/Extensions/GameObjectExtensions.cs
    public static class GameObjectExtensions
    {
        ...
        public static void DestroyOrDespawn(this GameObject gameObject)
        {
            if (gameObject.OrNull() == null)
                return;
